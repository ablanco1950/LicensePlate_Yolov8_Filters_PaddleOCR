...
#########################################################################
    ...
    Plate_infoMax,ConfMax = GetPaddleOcr(gray,Plate_infoMax,ConfMax)
    text=Plate_infoMax
    text = ''.join(char for char in text if char.isalnum())
    text=ProcessText(text)
    if ProcessText(text) != "":
    
           TabLicensesFounded, ContLicensesFounded, ContConf, =ApendTabLicensesFounded (TabLicensesFounded, ContLicensesFounded, ContConf, text)   
           if text==License:
            ...
            for x in range(len(TabImgSelect)):
                ...
                if licensemax == License:    
                   ...
                   TotHits+=1
                    ...
                    print(License + " Detected " + licensemax + " but not correctly recognized")
                    TotFailures +=1
                print ("")  
                lineaw=[]
                lineaw.append(License) 
                lineaw.append(licensemax)
                #lineaw.append(str(ConfMax))
